...
/* prototypes */
static void power_manager_plugin_construct (BladeBarPlugin *plugin);
/* register the plugin */
BLADE_BAR_PLUGIN_REGISTER (power_manager_plugin_construct);


static PowerManagerPlugin *
power_manager_plugin_new (BladeBarPlugin *plugin)
{
    PowerManagerPlugin *power_manager_plugin;

    /* allocate memory for the plugin structure */
    power_manager_plugin = bar_slice_new0 (PowerManagerPlugin);
...
static void
power_manager_plugin_construct (BladeBarPlugin *plugin)
{
    PowerManagerPlugin *power_manager_plugin;
