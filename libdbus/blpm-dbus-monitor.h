...
#define XFPM_TYPE_DBUS_MONITOR        (blpm_dbus_monitor_get_type () )
...
GType        		blpm_dbus_monitor_get_type        	(void) G_GNUC_CONST;

XfpmDBusMonitor        *blpm_dbus_monitor_new             	(void);

void			blpm_dbus_monitor_watch_system_bus	(XfpmDBusMonitor *monitor);

gboolean                blpm_dbus_monitor_add_unique_name     	(XfpmDBusMonitor *monitor,
								 DBusBusType bus_type,
								 const gchar *unique_name);
								   
void                    blpm_dbus_monitor_remove_unique_name    (XfpmDBusMonitor *monitor,
								 DBusBusType bus_type,
								 const gchar *unique_name);

gboolean		blpm_dbus_monitor_add_service	  	(XfpmDBusMonitor *monitor,
								 DBusBusType bus_type,
								 const gchar *service_name);

void			blpm_dbus_monitor_remove_service  	(XfpmDBusMonitor *monitor,
								 DBusBusType bus_type,
								 const gchar *service_name);
G_END_DECLS
