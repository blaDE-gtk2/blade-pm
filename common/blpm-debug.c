...
void
blpm_debug (const char *func, const char *file, int line, const char *format, ...)
{
    va_list args;
...
void
blpm_warn (const char *func, const char *file, int line, const char *format, ...)
{
    va_list args;
...
void blpm_debug_enum (const gchar *func, const gchar *file, gint line,
