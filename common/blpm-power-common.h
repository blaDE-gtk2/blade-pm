...
#define POLKIT_AUTH_SUSPEND_XFPM	"org.blade.power.xfce4-pm-helper"
#define POLKIT_AUTH_HIBERNATE_XFPM	"org.blade.power.xfce4-pm-helper"
...
const gchar *G_GNUC_CONST blpm_battery_get_icon_index (UpDeviceKind type, guint percent);
