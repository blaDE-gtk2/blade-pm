...
#define XFPM_TYPE_POLKIT        (blpm_polkit_get_type () )
...
GType        		   blpm_polkit_get_type        	(void) G_GNUC_CONST;

XfpmPolkit                *blpm_polkit_get             	(void);

gboolean		   blpm_polkit_check_auth	(XfpmPolkit *polkit,
