...
#define XFPM_TYPE_INHIBIT        (blpm_inhibit_get_type () )
...
GType        		  blpm_inhibit_get_type        (void) G_GNUC_CONST;
GType                     blpm_inhibit_error_get_type  (void) G_GNUC_CONST;
GQuark                    blpm_inhibit_get_error_quark ();

XfpmInhibit              *blpm_inhibit_new             (void);
