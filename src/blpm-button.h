...
#define XFPM_TYPE_BUTTON   (blpm_button_get_type () )
...
GType                 		blpm_button_get_type               	(void) G_GNUC_CONST;

XfpmButton       	       *blpm_button_new             		(void);

guint8                		blpm_button_get_mapped		     	(XfpmButton *button) G_GNUC_PURE;
