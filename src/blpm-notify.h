...
#define XFPM_TYPE_NOTIFY        (blpm_notify_get_type () )
...
GType        	 	  blpm_notify_get_type          	    (void) G_GNUC_CONST;
XfpmNotify      	 *blpm_notify_new                           (void);

void             	  blpm_notify_show_notification 	    (XfpmNotify *notify,
								     const gchar *title,
								     const gchar *text,
...
void 			  blpm_notify_add_action_to_notification    (XfpmNotify *notify, 
...
void 			  blpm_notify_present_notification 	    (XfpmNotify *notify, 
								     NotifyNotification *n,
								     gboolean simple);
								     
void                      blpm_notify_critical                      (XfpmNotify *notify,
								     NotifyNotification *n);
