...
#define XFPM_TYPE_SYSTEMD            (blpm_systemd_get_type () )
...
GType               blpm_systemd_get_type   (void) G_GNUC_CONST;

XfpmSystemd         *blpm_systemd_new   (void);

void                blpm_systemd_shutdown   (XfpmSystemd *systemd,
                                             GError **error);

void                blpm_systemd_reboot (XfpmSystemd *systemd,
                                         GError **error);
