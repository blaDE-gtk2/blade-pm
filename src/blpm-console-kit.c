...
static void blpm_console_kit_finalize   (GObject *object);

static void blpm_console_kit_get_property (GObject *object,
					   guint prop_id,
					   GValue *value,
					   GParamSpec *pspec);
...
G_DEFINE_TYPE (XfpmConsoleKit, blpm_console_kit, G_TYPE_OBJECT)

static void
blpm_console_kit_get_info (XfpmConsoleKit *console)
{
    GError *error = NULL;
    gchar *tmp = NULL;
...
static void
blpm_console_kit_class_init (XfpmConsoleKitClass *klass)
{
    GObjectClass *object_class = G_OBJECT_CLASS (klass);

    object_class->finalize = blpm_console_kit_finalize;

    object_class->get_property = blpm_console_kit_get_property;
...
static void
blpm_console_kit_init (XfpmConsoleKit *console)
{
    GError *error = NULL;
    ...
    blpm_console_kit_get_info (console);
}
...
static void
blpm_console_kit_finalize (GObject *object)
{
    XfpmConsoleKit *console;
    ...
    G_OBJECT_CLASS (blpm_console_kit_parent_class)->finalize (object);
}

XfpmConsoleKit *
blpm_console_kit_new (void)
{
...
void blpm_console_kit_shutdown (XfpmConsoleKit *console, GError **error)
{
...
void blpm_console_kit_reboot (XfpmConsoleKit *console, GError **error)
{
    g_return_if_fail (console->priv->proxy != NULL );
...
void
blpm_console_kit_suspend (XfpmConsoleKit *console,
                          GError        **error)
{
    g_return_if_fail (console->priv->proxy != NULL );
...
void
blpm_console_kit_hibernate (XfpmConsoleKit *console,
                            GError        **error)
{
    g_return_if_fail (console->priv->proxy != NULL );
