...
static GQuark blpm_error_quark = 0;

GQuark
blpm_get_error_quark (void)
{
    if (blpm_error_quark == 0)
	blpm_error_quark = g_quark_from_static_string ("blpm-error-quark");
	
    return blpm_error_quark;
}

GType
blpm_error_get_type (void)
{
    static GType type = 0;
