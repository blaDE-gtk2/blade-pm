...
#define XFPM_TYPE_KBD_BACKLIGHT        (blpm_kbd_backlight_get_type () )
...
GType                           blpm_kbd_backlight_get_type         (void) G_GNUC_CONST;

XfpmKbdBacklight               *blpm_kbd_backlight_new              (void);
