...
#define XFPM_TYPE_ERROR	(blpm_error_get_type  ())
#define XFPM_ERROR      (blpm_get_error_quark ())
...
GType	blpm_error_get_type  (void) G_GNUC_CONST;
GQuark  blpm_get_error_quark (void);
